...
const PublicationDetailPage: React.FC = () => {
  const course = {
    ...
    description:
      "Ceci est une description plus détaillée de la publications. La publication couvre divers sujets, y compris des concepts de base et avancés. Vous apprendrez également à appliquer ces concepts dans des situations pratiques.",
  };
